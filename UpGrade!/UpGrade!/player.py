...
class Player:
    ...
    def __init__(self):
        ...
        if self.sound == None:
            self.sound = load_wav('170170__timgormly__8-bit-pickup.wav')
    ...
    def update(self, frame_time):
        ...
        self.life_time +=1 * frame_time


        if self.life_time > 15:
            self.hp -= 1.50 * frame_time
        elif self.life_time > 30:
            self.hp -= 1.75 * frame_time
        elif self.life_time > 45:
            self.hp -= 2 * frame_time
        else:
            self.hp -= 1.25 * frame_time
    ...
    def pick(self,grade):
        self.sound.play()
        self.hp -= grade.damage
        self.point += grade.point
